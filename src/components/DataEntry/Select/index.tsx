        ...
        >
          {({ open }) => (
            ...
            >
              ...
              >
                {!props.multiple && !Array.isArray(value) && (
                  <div className="flex w-full items-center h-full flex-wrap py-[6px]">
                    ...
                    >
                      {value?.label ??
                        (props.placeholder ? props.placeholder : 'Chọn một lựa chọn')}
                    </div>
                  </div>
                )}
              ...
              >
                <ListboxOptions
                  className="fixed z-50 mt-1 max-h-72 h-min w-[var(--button-width)] overflow-auto rounded-md bg-white dark:bg-secondaryColorDark py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                  anchor="bottom start"
                >
                  {options?.map((op) => (
                    <ListboxOption
