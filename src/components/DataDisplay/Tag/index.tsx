        ...
        <>
            {
                ...
                >
                    ...
                    {closeable &&
                        <svg width="10" height="10" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleCloseTag} className='cursor-pointer mt-[3px] fill-[gray] hover:fill-[#242526] transition-colors duration-300 ease-in-out'>
